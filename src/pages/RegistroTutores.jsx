...
function RegistroTutores() {
    ...
    const carregarTutores = async () => {
        ...
        const tutoresData = await predefinicoesService.listTutors(token);
    ...
    return (
        <div style={{ backgroundColor: '#f8f9fa', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
                ...
                <Container fluid className="px-5">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="text-center mx-auto fw-medium mb-2">
                            ...
                            <Nav.Link onClick={() => navigate('/registro-tutores')} className="mx-2 text-dark fw-bold">Registro Tutores</Nav.Link>
            ...
            <Container className="my-5 flex-grow-1">
                ...
                {tutores.length > 0 ?
                    <RecordsTable user={tutores} route={'/relatorio-individual-tutor'} />
                    : <p className="text-center text-muted">Nenhum tutor encontrado</p>
                }
            </Container>
